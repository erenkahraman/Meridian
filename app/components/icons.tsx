/** Small inline SVG icons + reusable external links. Server-safe (no state). */
...
export const GITHUB_URL = "https://github.com/erenkahraman/Meridian";
export const LINKEDIN_URL = "https://www.linkedin.com/in/erenkahraman/";

/** GitHub + LinkedIn external links, styled via `.icon-link`. */
  ...
  return (
    <>
      <a
        ...
        aria-label="Meridian source on GitHub"
      >
      ...
      <a
        ...
        target="_blank"
        rel="noopener noreferrer"
        aria-label="Eren Kahraman on LinkedIn"
      >
